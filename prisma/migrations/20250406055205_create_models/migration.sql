...
CREATE TABLE "DealershipInfo" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL DEFAULT 'saarthAI Automotive',
    "address" TEXT NOT NULL DEFAULT 'Ludhiana, Punjab, India',
    "phone" TEXT NOT NULL DEFAULT '+91 8198898387',
    "email" TEXT NOT NULL DEFAULT 'contact@saarthAI.com',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
