...
export default function Home() {
  return (
    <div className="pt-20 flex flex-col">
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            <h1 className="text-5xl md:text-8xl mb-4 gradient-title">
              Find your dream car with saarthAI
            </h1>
              ...
              >
                <div className="overflow-hidden rounded-lg flex justify-end h-28 mb-4 relative">
                  <Image
                    ...
                    alt={type.name}
                    fill
                    className="object-cover group-hover:scale-105 transitio duration-300"
                  />
                </div>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
        <h2 className="text-2xl font-bold text-center margin-8">Frequently asked Questions</h2>
      ...
      <section className="py-16 dotted-background text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">Join thousands of satisfied customers who found their perfect ride through our platform:)</p>
